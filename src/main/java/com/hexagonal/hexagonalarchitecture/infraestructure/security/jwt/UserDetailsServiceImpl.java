package com.hexagonal.hexagonalarchitecture.infraestructure.security.jwt;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    //* ESTE METODO SIRVE PARA SABER QUE USUARIO ES QUIEN SE VA A LOGUEAR
    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        //* AQUI CARGAMOS EL USUARIO QUE SE QUIERE LOGUEAR CON SUS RESPECTIVOS PERMISOS
